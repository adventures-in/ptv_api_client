...
class RunsApi {
  ...
  Future<V3RunsResponse> runsForRoute(int routeId) async {
    ...
    String path = "/v3/runs/route/{route_id}"
    ...
    if (response.statusCode >= 400) {
      ...
      return V3RunsResponse.fromJson(decodeBodyBytes(response));
    } else {
      return null;
    }
  }
  ...
  ///
  ///
  Future<V3RunsResponse> runsForRouteAndRouteType(
      int routeId, int routeType) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/v3/runs/route/{route_id}/route_type/{route_type}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "route_id" + "}", routeId.toString())
  ...
  Future<V3RunResponse> runsForRunAndRouteType(int runId, int routeType) async {
    ...
    // create path and map variables
    String path = "/v3/runs/{run_id}/route_type/{route_type}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "run_id" + "}", runId.toString())
        .replaceAll("{" + "route_type" + "}", routeType.toString());
    ...
    if (response.statusCode >= 400) {
      ...
      return V3RunResponse.fromJson(decodeBodyBytes(response));
    } else {
      return null;
    }
  }
