...
class DeparturesApi {
  ...
  DeparturesApi([ApiClient apiClient])
      : apiClient = apiClient ?? defaultApiClient;

  /// View departures for all routes from a stop
  ///
  ///
  Future<V3DeparturesResponse> departuresGetForStop(int routeType, int stopId,
    ...
    String path = "/v3/departures/route_type/{route_type}/stop/{stop_id}"
  ...
  ///
  ///
  Future<V3DeparturesResponse> departuresGetForStopAndRoute(
