...
class OutletsApi {
  ...
  ///
  ///
  Future<V3OutletGeolocationResponse> outletsGetOutletsByGeolocation(
      double latitude, double longitude,
      {double maxDistance, int maxResults}) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/v3/outlets/location/{latitude},{longitude}"
