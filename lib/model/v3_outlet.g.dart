...
part of 'v3_outlet.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<V3Outlet> _$v3OutletSerializer = new _$V3OutletSerializer();

class _$V3OutletSerializer implements StructuredSerializer<V3Outlet> {
  @override
  final Iterable<Type> types = const [V3Outlet, _$V3Outlet];
  @override
  final String wireName = 'V3Outlet';

  @override
  Iterable<Object> serialize(Serializers serializers, V3Outlet object,
  ...
  @override
  V3Outlet deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new V3OutletBuilder();
...
class _$V3Outlet extends V3Outlet {
  @override
  ...
  factory _$V3Outlet([void Function(V3OutletBuilder) updates]) =>
      (new V3OutletBuilder()..update(updates)).build();
  ...
  _$V3Outlet._(
    ...
    if (outletSlidSpid == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletSlidSpid');
    }
    if (outletName == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletName');
    }
    if (outletBusiness == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusiness');
    }
    if (outletLatitude == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletLatitude');
    }
    if (outletLongitude == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletLongitude');
    }
    if (outletSuburb == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletSuburb');
    }
    if (outletPostcode == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletPostcode');
    }
    if (outletBusinessHourMon == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourMon');
    }
    if (outletBusinessHourTue == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourTue');
    }
    if (outletBusinessHourWed == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourWed');
    }
    if (outletBusinessHourThur == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourThur');
    }
    if (outletBusinessHourFri == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourFri');
    }
    if (outletBusinessHourSat == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourSat');
    }
    if (outletBusinessHourSun == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletBusinessHourSun');
    }
    if (outletNotes == null) {
      throw new BuiltValueNullFieldError('V3Outlet', 'outletNotes');
    }
  }

  @override
  V3Outlet rebuild(void Function(V3OutletBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  V3OutletBuilder toBuilder() => new V3OutletBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is V3Outlet &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('V3Outlet')
...
class V3OutletBuilder implements Builder<V3Outlet, V3OutletBuilder> {
  _$V3Outlet _$v;
  ...
  @override
  void replace(V3Outlet other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$V3Outlet;
  }

  @override
  void update(void Function(V3OutletBuilder) updates) {
