...
part 'v3_result_outlet.g.dart';

abstract class V3ResultOutlet
    implements Built<V3ResultOutlet, V3ResultOutletBuilder> {
  ...
  factory V3ResultOutlet([updates(V3ResultOutletBuilder b)]) = _$V3ResultOutlet;

  Map<String, Object> toJson() {
    return serializers.serializeWith(V3ResultOutlet.serializer, this);
  }

  static V3ResultOutlet fromJson(String jsonString) {
    return serializers.deserializeWith(
        V3ResultOutlet.serializer, json.decode(jsonString));
  }

  static Serializer<V3ResultOutlet> get serializer =>
      _$v3ResultOutletSerializer;
}
