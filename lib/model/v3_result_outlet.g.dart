...
part of 'v3_result_outlet.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<V3ResultOutlet> _$v3ResultOutletSerializer =
    new _$V3ResultOutletSerializer();

class _$V3ResultOutletSerializer
    implements StructuredSerializer<V3ResultOutlet> {
  @override
  final Iterable<Type> types = const [V3ResultOutlet, _$V3ResultOutlet];
  @override
  final String wireName = 'V3ResultOutlet';

  @override
  Iterable<Object> serialize(Serializers serializers, V3ResultOutlet object,
  ...
  @override
  V3ResultOutlet deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new V3ResultOutletBuilder();
...
class _$V3ResultOutlet extends V3ResultOutlet {
  @override
  ...
  factory _$V3ResultOutlet([void Function(V3ResultOutletBuilder) updates]) =>
      (new V3ResultOutletBuilder()..update(updates)).build();
  ...
  _$V3ResultOutlet._(
    ...
    if (outletDistance == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletDistance');
    }
    if (outletSlidSpid == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletSlidSpid');
    }
    if (outletName == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletName');
    }
    if (outletBusiness == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletBusiness');
    }
    if (outletLatitude == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletLatitude');
    }
    if (outletLongitude == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletLongitude');
    }
    if (outletSuburb == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletSuburb');
    }
    if (outletPostcode == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletPostcode');
    }
    if (outletBusinessHourMon == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourMon');
    }
    if (outletBusinessHourTue == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourTue');
    }
    if (outletBusinessHourWed == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourWed');
    }
    if (outletBusinessHourThur == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourThur');
    }
    if (outletBusinessHourFri == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourFri');
    }
    if (outletBusinessHourSat == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourSat');
    }
    if (outletBusinessHourSun == null) {
      throw new BuiltValueNullFieldError(
          'V3ResultOutlet', 'outletBusinessHourSun');
    }
    if (outletNotes == null) {
      throw new BuiltValueNullFieldError('V3ResultOutlet', 'outletNotes');
    }
  }

  @override
  V3ResultOutlet rebuild(void Function(V3ResultOutletBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  V3ResultOutletBuilder toBuilder() =>
      new V3ResultOutletBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is V3ResultOutlet &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('V3ResultOutlet')
...
class V3ResultOutletBuilder
    implements Builder<V3ResultOutlet, V3ResultOutletBuilder> {
  _$V3ResultOutlet _$v;
  ...
  V3ResultOutletBuilder();

  V3ResultOutletBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(V3ResultOutlet other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$V3ResultOutlet;
  }

  @override
  void update(void Function(V3ResultOutletBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$V3ResultOutlet build() {
    final _$result = _$v ??
        new _$V3ResultOutlet._(
